...
import com.payoneer.jobmgmtservice.interceptor.UserInterceptor;
 ...
 */
@Configuration
public class PayoneerConfiguration implements WebMvcConfigurer {
    ...
    @Bean
    public ClassLoaderTemplateResolver templateResolver(){  /* Define the view resolver for thymeleaf templates from controller */
