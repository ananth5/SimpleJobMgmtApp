 ...
 * Main entry class to schedule job customer TO DB migration job
 */
@Component
public class CustomerToDbScheduledJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			currJob = customertoDbJobConfig.jobBuilder();
